  ...
  return (
    <div className="flex items-center gap-3 p-3.5 rounded-xl bg-surface-alt/80">
      ...
      <div className="min-w-0">
        ...
        {/* Alguns registros trazem um paragrafo no lugar do valor, entao o texto inteiro fica no title. */}
        <p className="text-sm font-semibold text-text truncate" title={value}>{value}</p>
      </div>
    </div>
  )
}
