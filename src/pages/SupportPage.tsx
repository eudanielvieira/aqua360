  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-card rounded-2xl shadow-sm shadow-black/5 p-6 sm:p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-text mb-2">{t('heading')}</h2>
        ...
        <div className="my-6 py-6 border-y border-border/60">
          {tab === 'pix' ? (
            <>
              <p className="text-xs font-bold text-text-secondary uppercase tracking-wider mb-4">{t('pix.title')}</p>
              ...
              {PIX_KEY ? (
                <>
                  ...
                  <p className="text-xs text-text-secondary mb-2">{t('pix.key')}</p>
                  <button
                    onClick={handleCopy}
                  ...
                  {copied && <p className="text-xs text-emerald-500 mt-2 font-medium">{t('pix.copied')}</p>}
                </>
              ) : (
                <div className="w-48 h-48 mx-auto bg-surface-alt rounded-xl flex items-center justify-center mb-4">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-text-secondary">{t('pix.qrSoon')}</p>
                  </div>
                </div>
              )}
            </>
            ...
            <>
              <p className="text-xs font-bold text-text-secondary uppercase tracking-wider mb-4">{t('bmac.title')}</p>
        ...
        <div className="grid gap-4 sm:grid-cols-3 text-left">
          <div className="p-4 rounded-xl bg-surface-alt/50">
            ...
            <p className="text-xs text-text-secondary mt-1">{t('benefit.server.desc')}</p>
          </div>
          <div className="p-4 rounded-xl bg-surface-alt/50">
